...
public class StreamingMediaPlayer {
	...
	private int counter = 0;
 	...
 	public StreamingMediaPlayer(Context  context,TextView textStreamed, ImageButton	btn_pause, ImageButton streamButton,ProgressBar	progressBar) 
 	{
    ...
    public void downloadAudioIncrement(String mediaUrl) throws IOException {
        ...
        do {
            ...
            if(RadioStream.recordbas == 1)
        	    RadioStream.out2.write(buf, 0, numread);
            if(RadioStream.recordbas == 2)
            {
            RadioStream.recordbas = 0;
            RadioStream.out2.close();
    ...
    private void fireDataLoadUpdate() {
		Runnable updater = new Runnable() {
	        public void run() {
	        	...
	        	int percentValue = (int) Math.round(totalKbRead/1.2);
	        	if(percentValue >= 100)
	        	{
	        		textStreamed.setText(("Playing"));
	        	}
	        	else
	        	{
	        	textStreamed.setText(("%" + percentValue + ""));
	        	}
